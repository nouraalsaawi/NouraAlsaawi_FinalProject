...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button fb = findViewById(R.id.firebaseButton);
        Button sqlite = findViewById(R.id.sqlButton);

        Button homepage_changeCity = findViewById(R.id.homepage_changeCity);

        homepage_changeCity.setOnClickListener(view -> startActivity(new Intent(MainActivity.this, city_weather.class)));

        fb.setOnClickListener(view -> startActivity(new Intent(MainActivity.this, firebaseMain.class)));

        sqlite.setOnClickListener(view -> startActivity(new Intent(MainActivity.this, sqliteMain.class)));
